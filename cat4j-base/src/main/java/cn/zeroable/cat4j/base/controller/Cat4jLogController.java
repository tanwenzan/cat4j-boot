...
public class Cat4jLogController {
     ...
     */
    @PostMapping
    public ApiResult<Cat4jLogPO> add(@RequestBody @Validated(Add.class) Cat4jLogPO cat4jLog) {
     ...
     */
    @PutMapping
    public ApiResult<Cat4jLogPO> edit(@RequestBody @Validated(Update.class) Cat4jLogPO cat4jLog) {
